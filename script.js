document.addEventListener("DOMContentLoaded", () => {
  ...
  function openProjectModal(project) {
    ...
    let html = '';
    if (project === 'school') {
      html = `<h2>🏫 School Management System</h2>
        <p><b>Python, CSV, Desktop</b></p>
        <ul><li>Efficiently store and manage student, teacher, and staff data.</li><li>Advanced search, filter, and reporting features.</li></ul>
        <a href='https://github.com/Drashvi/School-Mnagement-System' target='_blank' class='btn'>🔗 View on GitHub</a>`;
    } else if (project === 'campus') {
      html = `<h2>🎓 Smart Campus App</h2>
        <p><b>React, Web</b></p>
        <ul><li>Real-time event tracking and campus solutions.</li><li>Responsive UI and user engagement features.</li></ul>
        <a href='https://github.com/TheDeceiver31/Fuzz_our-college-app' target='_blank' class='btn'>🔗 View on GitHub</a>`;
    }
